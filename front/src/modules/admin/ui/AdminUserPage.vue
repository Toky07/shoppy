...
<template>
  <section class="animate-fade-in">
    ...
    <div class="mt-6 grid max-w-4xl gap-5 lg:grid-cols-2">
      <form class="panel h-fit space-y-5 p-6" @submit.prevent="onLoad">
      ...
      <form v-if="user" class="panel h-fit space-y-5 p-6" @submit.prevent="onSave">
